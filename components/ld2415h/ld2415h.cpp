...
#endif
#ifdef USE_SELECT
  this->sample_rate_selector_->publish_state(i_to_s(SAMPLE_RATE_STR_TO_INT, this->sample_rate_));
  this->tracking_mode_selector_->publish_state(i_to_s(TRACKING_MODE_STR_TO_INT, this->tracking_mode_));
#endif
}
